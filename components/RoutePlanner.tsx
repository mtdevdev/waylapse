        ...
        <div className="pt-2 animate-slide-in-up" style={{ animationDelay: '500ms' }}>
            <div className="flex gap-2 mb-4">
                <button 
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-neutral-900/40 border border-white/5 inner-border-highlight rounded-xl text-neutral-400 hover:text-white hover:bg-neutral-900/60 hover:border-white/10 transition-all group"
                >
